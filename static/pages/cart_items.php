          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>PHP$displayShipping</span>";
                else $displayShipping = "PHP$displayShipping";

                if ($sumTotal >= 2000){
                  $shippingTotal = $sumTotal - 100;
                  $displayPVoucher = "<span class='underline'>-PHP100</span> <span class='yellow-text'>(Promo voucher applied)</span>";
                }
                ...
                echo("<tr><th>Sum Total:</th><td>PHP$sumTotal</td></tr>");
