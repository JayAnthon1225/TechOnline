...
<head>
  ...
  <title>Tech Ownline - Landing Page</title>
  <?php 
    require "header.php"; 
...
<body>
  <div class="slider" style="width: 60%; margin: auto;">
    <ul class="slides">
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3 class="bold page-title">At Tech Ownline</h3>
  ...
  <div class="section" style="margin-top: 100px;">
    <div class="wide-container">
      ...
      <h5 class="white-text center">
        At <b class="orange-text">Tech Ownline</b>, We are a team of serious gamers and overclockers with a passion towards customized and fast PCs.
      </h5>
    </div>
  </div>
  ...
  <h3 class="white-text center">Tech Ownline - White PC Build</h3>
    ...
    <div class="grid">
      <div class="rounded-card-parent">
        <div class="card rounded-card tint-glass-black" style="height: 300px; width: 250px;">
          ...
          <h5 class="orange-text bold center" style="display: inline;">Guaranteed Quality</h5>
            <h5 class="white-text bold center" style="display: inline;"></h5>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="rounded-card-parent">
        <div class="card rounded-card tint-glass-black" style="height: 300px; width: 250px;">
          ...
          <div class="row center">
          <h5 class="orange-text bold center" style="display: inline;">Guaranteed Return/Warranty</h5>
    ...
    <div class="grid">
      <div class="rounded-card-parent">
        <div class="card rounded-card tint-glass-black" style="height: 300px; width: 250px;">
          ...
          <div class="row center">
          <h5 class="orange-text bold center" style="display: inline;">Technical Support</h5>
    ...
    <div class="grid">
      <div class="rounded-card-parent">
        <div class="card rounded-card tint-glass-black" style="height: 300px; width: 250px;">
          ...
          <div class="row center">
          <h5 class="orange-text bold center" style="display: inline;">EXTRA Rebate For Upgrades</h5>
    ...
    <div class="grid">
      <div class="rounded-card-parent">
        <div class="card rounded-card tint-glass-black" style="height: 300px; width: 250px;">
          ...
          <div class="row center">
          <h5 class="orange-text bold center" style="display: inline;">Approved by SEC</h5>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="rounded-card-parent">
        <div class="card rounded-card tint-glass-black" style="height: 300px; width: 250px;">
          ...
          <div class="row center">
            <h5 class="orange-text bold center" style="display: inline;">Highly Professional</h5>
